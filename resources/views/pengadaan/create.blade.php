...
<div class="col-md-8">
    <div class="card shadow mb-4">
      ...
      <form enctype="multipart/form-data"  class="bg-white shadow-sm p-3" action="{{route('pengadaan.store')}}" method="POST">
        ...
        <a href="{{route('pengadaan.index')}}" class="btn btn-secondary btn-sm"><i class="fa fa-arrow-circle-left fa-fw fa-sm"></i>Kembali</a>
        </form>
      </div>
      </div>
    </div>
