    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        <div class="sidebar-brand-icon">
          <img src="{{asset('public/image/logo.png')}}" width="60px">
      </div>
        <div class=" mx-auto">Procurement</div>
      </a>
      ...
      <li class="nav-item ">
        <a class="nav-link" href="{{route('penyedia.index')}}">
          ...
          <span>Data Penyedia</span></a>
      </li>

      <li class="nav-item ">
        <a class="nav-link" href="{{route('penyedia.perubahan')}}">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">
            <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
            <path d="M7 5.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0zM7 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0z"/>
          </svg>
          <span>Perubahan Data Penyedia</span></a>
      </li>
      <div class="sidebar-heading">
       Informasi Pengadaan
     </div>
     ...
     <li class="nav-item">
      ...
      <li class="nav-item ">
        ...
        <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item " href="{{route('user.index')}}">Master Admin</a>
          <a class="collapse-item " href="{{route('user.daftar')}}">Manage User</a>
          </div>
        </div>
      </li>
     @endif
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; E-Procurement Perumda Danum Taka Penajam Paser Utara </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
