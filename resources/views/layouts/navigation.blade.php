        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('userdashboard.index')" :active="request()->routeIs('userdashboard.index')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
                @php
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('paketbaru.index')" :active="request()->routeIs('paketbaru.index')">
                        {{ __('Paket Baru') }}
                    </x-nav-link>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('kotakmasuk.index')" :active="request()->routeIs('kotakmasuk.index')">
                        {{ __('Kotak Masuk') }}
                    </x-nav-link>
                ...
                @endif
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dataperusahaan')" :active="request()->routeIs('dataperusahaan')">
                        {{ __('Data Perusahaan') }}
                    </x-nav-link>
