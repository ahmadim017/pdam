...
<tr>
  ...
  @endif  
    ...
    @if ($jadwal)
    <a href="{{route('jadwaltender.view',[$pengadaan->id])}}" class="badge badge-secondary">Jadwal Paket</a>
    @else
    <a href="{{route('jadwaltender.buat',[$pengadaan->id])}}" class="badge badge-secondary"> Belum ada Jadwal </a>
    @endif
