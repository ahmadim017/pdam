    ...
    <div class="col">
      <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
        <ol class="breadcrumb mb-0">
          <li class="breadcrumb-item"><a href="{{route('penyedia.index')}}">Daftar Penyedia</a></li>
...
@if(Auth::user()->role == 'VERIFIKATOR')
 <div class="text-right mb-4">
  <form onsubmit="return confirm('Apakah Anda Yakin Permohonan diterima?')" action="{{ route('penyedia.update', [$pengajuan->id]) }}" class="d-inline" method="POST">
    @csrf
    @method('PUT')
  ...
  <a href="#" data-toggle="modal" data-target="#catatan" class="btn btn-danger btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
 ...
 <div class="modal fade" id="catatan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form onsubmit="return confirm('Apakah Permohonan ini Benar Tidak Sesuai?')" action="#" class="d-inline" method="POST">
          @csrf
          @method('PUT')
