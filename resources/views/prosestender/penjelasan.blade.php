<x-app-layout>
    ...
    <nav class="flex px-5 py-3 mt-6 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 " aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{route('prosestender.show',[$prosestender->id])}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 ">Informasi Paket</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
                    ...
                    <div class="relative w-full max-w-6xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form class="p-4 md:p-5" method="POST" action="{{route('pertanyaan.store')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id_paket" value="{{$prosestender->id_paket}}">
