<x-app-layout>
    ...
    <nav class="flex px-5 py-3 mt-6 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{route('prosestender.penjelasan',[$prosestender->id])}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Pemberian Penjelasan</a>
            </div>
        </li>
        </ol>
    </nav>
  ...
  <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
              <h1 class="font-semibold text-2xl">Informasi Tender</h1>
              <hr class="my-4 border-2 border-cyan-700">
              <form action="{{route('prosestender.update',[$prosestender->id])}}" onsubmit="return confirm('Apakah Anda Yakin dengan penawaran Anda?')" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <tr class="border-b">
                    ...
                    <td class="pl-2">
                      ...
                      <tr class="border-b">
                        ...
                        <td class="pl-2">
                          Rp. {{number_format($prosestender->tender->hps)}}
                        </td>
                    </tr>
                    <tr class="border-b">
                        <th scope="col" class="px-6 py-3 bg-gray-100">
                        ...
                        <td class="pl-2">
                            {{ $prosestender->tender->detailtender->metodepengadaan}}
                        </td>
                    </tr>
                    <tr class="border-b">
                        <th scope="col" class="px-6 py-3 bg-gray-100">
                        ...
                        <td class="pl-2">
                          {{ $prosestender->tender->tahunanggaran}}
                        </td>
                    </tr>
                    <tr class="border-b">
                        <th scope="col" class="px-6 py-3 bg-gray-100">
                      ...
                      <tr class="border-b">
                        ...
                        <td class="pl-2">
                            ...
                            foreach ($jadwal as $a) {
                                ...
                                if ($prosestender->id_paket == $a->id_paket && $jadwalDate == now()->toDateString()) {
                    ...
                    <tr class="border-b">
                        ...
                        <div class="max-w-3xl bg-white border border-gray-200 rounded-lg shadow ">
                            ...
                            <div id="defaultTabContent">
                                ...
                                <div class="p-4">
                                    <a href="{{asset('storage/app/public/dist/filepenawaran/'.$prosestender->filepenawaran)}}" target="_blank" class="inline-flex items-center p-2 rounded-md bg-cyan-700 text-xs text-white"> Download Dokumen Penawaran</a>
                                </div>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="pl-2">
                            <input type="date" value="{{ old('tglsuratpenawaran', $prosestender->tglsuratpenawaran ?? '') }}"  name="tglsuratpenawaran" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="pl-2">
                            @php
                                ...
                                $hargaPenawaran = old('hargapenawaran', $prosestender->hargapenawaran ?? '0');
