...
class rancangankontrakController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $folder = 'dist/rancangankontrak'; // Ubah sesuai dengan folder yang diinginkan
    ...
    {
        $kak = rancangankontrak::findOrfail($id);
